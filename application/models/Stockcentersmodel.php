<?php
class Stockcentersmodel extends CI_Model {
    static $perpage = 32;
    ...
    function get_stockcenters($city,$pagenum,$cat="all"){
        ...
        ->where('company.hasStockCenter',1)
    ...
    function get_stockcentersCount($city = 'all',$cat='all'){ 
